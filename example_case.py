...
case_2 = Case(
    ...
    "Die Adresse des Notfalls ist: Gartenstraße 18, Ludwigshafen am Rhein, du bist sehr nervös und gibst die Adresse zuerst unvollständig oder durcheinander an, kannst sie aber auf Nachfrage korrekt nennen."
...
case_3 = Case(
    ...
    "Die Adresse des Notfalls ist: Landauer Straße 42, 67434 Neustadt an der Weinstraße, du kennst dich dort nicht gut aus und beschreibst anfangs eher die Umgebung, kannst die Adresse aber mit Straßenschild und Hausnummer nennen."
...
case_4 = Case(
    ...
    "Die Adresse des Notfalls ist: Schulstraße 7, 67655 Kaiserslautern, du bist zuhause und kennst die Adresse, gibst sie aber wegen deiner Aufregung erst nach Nachfrage vollständig an."
...
case_5 = Case(
    ...
    "Die Adresse des Notfalls ist: Bahnhofstraße 55, 66424 Homburg, du bist bei deiner Nachbarin in der Wohnung und musst kurz auf das Klingelschild schauen, kannst die Adresse aber korrekt nennen."
...
case = Case(
    ...
    caller_name="Heribert Schmolka",
    language='en',
    caller_prompt= json.dumps("You are playing a person in Germany who calls 112. You are upset, speak in short sentences, and primarily provide information when the calltaker asks for it. You are a medical layperson and can only describe what you see or experience yourself. Do not invent any medical facts that are not included in the case description."
    ...
    "The emergency address is: Hauptstraße 123, 66123 Saarbrücken. You should sometimes give the address only hesitantly because you are upset, but you live there and of course know the address."
...
case_2 = Case(
    ...
    caller_name="Heribert Schmolka",
    language='en',
    caller_prompt= json.dumps("You are playing a person in Germany who calls 112. You are very upset, speak in a choppy way, and occasionally repeat yourself. You primarily provide information when the calltaker asks for it. You are a medical layperson and can only describe what you see or experience yourself. Do not invent any medical facts that are not included in the case description."
    "Stay in character and answer exclusively in English.\n\n"
    ...
    "The emergency address is: Gartenstraße 18, 67063 Ludwigshafen am Rhein. You are very nervous and at first give the address incompletely or mixed up, but you can state it correctly when asked."
...
case_3 = Case(
    ...
    caller_name="Heribert Schmolka",
    language='en',
    caller_prompt= json.dumps("You are playing a person in Germany who calls 112. You are upset but trying to stay calm. There is traffic noise in the background, you are unsure what exactly happened, and you primarily provide information when the calltaker asks for it. You are a medical layperson and can only describe what you see or hear yourself. Do not invent any medical facts that are not included in the case description."
    "Stay in character and answer exclusively in English.\n\n"
    ...
    "The emergency address is: Landauer Straße 42, 67434 Neustadt an der Weinstraße. You do not know the area well and initially describe the surroundings rather than the exact address, but you can state the street sign and house number."
...
case_4 = Case(
    ...
    caller_name="Heribert Schmolka",
    language='en',
    caller_prompt= json.dumps("You are playing a person in Germany who calls 112. You are worried but not panicking. You speak rather quickly and are unsure whether it is really an emergency. You primarily provide information when the calltaker asks for it. You are a medical layperson and can only describe what you see or experience yourself. Do not invent any medical facts that are not included in the case description."
    "Stay in character and answer exclusively in English.\n\n"
    ...
    "The emergency address is: Marktplatz 1, 76829 Landau in der Pfalz. You are at an event there and need to briefly look up the exact address, but you can state it."
...
case_5 = Case(
    ...
    "The emergency address is: Schulstraße 7, 67655 Kaiserslautern. You are at home and know the address, but because you are upset you only give it fully after being asked."
...
case_6 = Case(
    ...
    caller_name="Heribert Schmolka",
    language='en',
    caller_prompt= json.dumps("You are playing a person in Germany who calls 112. You are upset and somewhat overwhelmed because the situation happened suddenly. You speak in short sentences and primarily provide information when the calltaker asks for it. You are a medical layperson and can only describe what you see or experience yourself. Do not invent any medical facts that are not included in the case description."
    "Stay in character and answer exclusively in English.\n\n"
    ...
    "The emergency address is: Bahnhofstraße 55, 66424 Homburg. You are in your neighbor’s apartment and need to briefly check the doorbell nameplate, but you can state the address correctly."
